...
🚀 **Aspiring Data Scientist** | 📊 **Passionate About Data** | 💻 **Enthusiastic Programmer**  
...
- 📜 **Published Research**: *Automatic Number License Plate Detection* in an **International Research Journal**  
- 🔬 **Internships**:  
  - **Innovate Intern** (IoT-based projects)  
  - **InternShala** (Arduino programming)  
- 🎓 **Workshops**: *Electronics in Software-Driven Vehicular Technology*  
- 🎭 **Leadership & Events**:  
  - **Class Representative** (2020-2022)  
  - **Active NSS Member**  
  - **Event Organizer** at college fests like *Cursor 2k-24* 🎉  
...
🛠 Exploring **new technologies** & **solving logical challenges**  
